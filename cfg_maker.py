...
def make_cfg():
    ...
    cfg = AppConfig(
        ...
        LOG_FILE_PATH=_get_env("LOG_FILE_PATH", None),
        LOG_TO_FILE=_get_env_bool("LOG_TO_FILE", False),
        LOG_TO_STDOUT=_get_env_bool("LOG_TO_STDOUT", True),
        ...
        CONSOLE_MODE=_get_env("CONSOLE_MODE", "prompt"),
